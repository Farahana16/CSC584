...
<body>
                            ...
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a class="active" href="rooms.jsp">rooms</a></li>
                        ...
                        <div class="col-xl-5 col-lg-4 d-none d-lg-block">
                            <div class="book_room">
                                ...
                                <div class="book_btn d-none d-lg-block">
                                    <a class="popup-with-form" href="AddBookingController?custid=<%=resultSet.getString("custid") %>" data-toggle='tab'>Book A Room</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-4 col-md-4">
                    <div class="single_offers">
                        <div class="about_thumb">
                            <img src="img/offers/dome2.jpeg" alt="" style="height: 348px;">
                        </div>
                        <h3>Up to 35% savings on Dome style <br> 
                                rooms and Suites</h3>
                        <ul>
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="single_offers">
                        <div class="about_thumb">
                            <img src="img/offers/classics2.jpg" alt="">
                        </div>
                        <h3>Up to 35% savings on Classics <br> 
                                rooms and Suites</h3>
                        <ul>
                            <li>Luxaries condition</li>
                            <li>4 Adults & 3 Children size</li>
                            <li>Forest view side</li>
                        </ul>
                        <a href="#" class="book_now">book now</a>
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="single_offers">
                        <div class="about_thumb">
                            <img src="img/offers/fam2.webp" alt="" style="height: 348px;">
                        </div>
                        <h3>Up to 35% savings on Family <br> 
                                rooms and Suites</h3>
                        <ul>
                            <li>Luxaries condition</li>
        ...
        <div class="rooms_here">
            <div class="single_rooms">
                <div class="room_thumb">
                    <img src="img/rooms/dome.jpeg" alt="">
            ...
            <div class="single_rooms">
                <div class="room_thumb">
                    <img src="img/rooms/classics.jpeg" alt="" style="height: 486px;"> 
                    <div class="room_heading d-flex justify-content-between align-items-center">
                        <div class="room_heading_inner">
                            <span>From RM200/night</span>
                            <h3>The Classics</h3>
                        </div>
                        <a href="#" class="line-button">book now</a>
                    </div>
            ...
            <div class="single_rooms">
                <div class="room_thumb">
                    <img src="img/rooms/fam.jpg" alt="" style="height: 486px;">
                    <div class="room_heading d-flex justify-content-between align-items-center">
                        <div class="room_heading_inner">
                            <span>From RM350/night</span>
                            <h3>The Family Suite</h3>
                        </div>
                        <a href="#" class="line-button">book now</a>
                    </div>
                </div>
            ...
            <div class="single_rooms">
                <div class="room_thumb">
                    <img src="img/rooms/traditional.jpeg" alt="" style="height: 486px;">
                    <div class="room_heading d-flex justify-content-between align-items-center">
                        <div class="room_heading_inner">
                            <span>From RM200/night</span>
    ...
    <div class="instragram_area">
        <div class="single_instagram">
            <img src="img/instragram/dome.jpg" alt="" style="height: 303px;">
            <div class="ovrelay">
                <a href="#">
                    <i class="fa fa-instagram"></i>
                </a>
        ...
        <div class="single_instagram">
            <img src="img/instragram/fam.jpg" alt="" style="height: 303px;">
            <div class="ovrelay">
                <a href="#">
                    <i class="fa fa-instagram"></i>
                </a>
        ...
        <div class="single_instagram">
            <img src="img/instragram/class.jpg" alt="" style="height: 303px;">
            <div class="ovrelay">
                <a href="#">
                    <i class="fa fa-instagram"></i>
                </a>
        ...
        <div class="single_instagram">
            <img src="img/instragram/fam2.jpg" alt="" style="height: 303px;">
            <div class="ovrelay">
                <a href="#">
                    <i class="fa fa-instagram"></i>
                </a>
        ...
        <div class="single_instagram">
            <img src="img/instragram/fam3.jpg" alt="" style="height: 303px;">
            <div class="ovrelay">
                <a href="#">
                    <i class="fa fa-instagram"></i>
                </a>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    <!-- form itself end-->
    <form id="formBook" class="white-popup-block mfp-hide" method="post" action="AddBookingController">
        <div class="popup_box ">
