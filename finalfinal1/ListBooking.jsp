    ...
    <div class="listBooking">
        ...
        <table id="bookings">
            ...
            <tr>
                ...
                <td>
                <a href="AddPaymentController?bookingID=<c:out value="${bk.bookingID}"/>" >Pay</a>
                <a href ="#" id="<c:out value="${bk.bookingID}"/>"  onclick="confirmation(this.id)" class="Delete" >Delete</a></td>
            </tr>
...
<!-- form itself end -->
    ...
    <script>
        ...
        function confirmation(bookingID){
			...
			if(r == true){
				location.href = 'DeleteBookingController?bookingID=' + bookingID;
