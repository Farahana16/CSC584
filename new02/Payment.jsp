            ...
            <div class="row">
                ...
                <div class="containerPayment">
                    ...
                    <form method="post" action="AddPaymentController">
                        ...
                        Payment Type<br><br>
                        <input type="radio" name="paymentType" value="Visa"/><img src="img/visa.png" style="height: 10%;">
                        <input type="radio" name="paymentType" value="MasterCard"/><img src="img/mastercard.png" style="height: 10%;"><br><br>
                        
                        <input type="hidden" name="bookingID" value="<c:out value="${c.bookingID}"/>" style="width: 100%;" >
