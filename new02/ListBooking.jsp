    ...
    <div class="listBooking">
        ...
        <table id="bookings">
            ...
            <tr>
                ...
                <td><a href ="#" id="<c:out value="${bk.bookingID}"/>" onclick="confirmation(this.id)" class="Delete" >Delete</a>
                <a href="Payment.jsp?bookingID=<c:out value="${bk.bookingID}"/>">Pay</a>
                <a href ="#" id="<c:out value="${bk.bookingID}"/>"  class="Delete" >Delete</a></td>
            </tr>
